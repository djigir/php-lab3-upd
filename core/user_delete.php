...
if (isset($_POST['id_user'])) {
    ...
    echo '<meta http-equiv="refresh" content="3; URL=http://php.com/lab3/core/user_list.php" />'; //перенапраляю на страницу с списком всех пользователей с задержкой в 3 сек
}
?>
